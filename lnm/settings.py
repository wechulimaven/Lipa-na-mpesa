"""
Django settings for lnm project.
...
SECRET_KEY = 'django-insecure-(a_yqt07_6@@%^3nlhjj93+$@61s6$or0z%-e=8m&0p84bm!up'
...
WSGI_APPLICATION = 'lnm.wsgi.application'
